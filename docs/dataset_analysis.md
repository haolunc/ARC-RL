...
## ARC-AGI-2 Test Case 数量分布

每个 task 包含若干 test case，并非所有 task 都只有 1 个 test case：

| 数据集 | 总任务数 | 1个test | 2个test | 3个test | 4个test |
|--------|---------|---------|---------|---------|---------|
| Training | 1,000 | 931 (93.1%) | 63 | 5 | 1 |
| Evaluation | 120 | 75 (62.5%) | 43 | 2 | 0 |
